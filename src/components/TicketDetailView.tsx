    ...
    return (
        ...
        >
                ...
                <div className="flex items-center gap-2">
                    <TooltipProvider>
                        ...
                        <Tooltip>
                            ...
                            <TooltipContent><p className="text-xs">{isFullScreen ? "Exit full screen" : "Go full screen"}</p></TooltipContent>
                        </Tooltip>
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className={cn("shrink-0 border-l border-border bg-[#F4F5F7] p-6 space-y-8 overflow-y-auto transition-all", isFullScreen ? "w-[320px]" : "w-[200px]")}>
                        ...
                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                {ticket.assignees.slice(0, 4).map((a: any, idx: number) => (
                                                    <div key={idx} className="flex items-center gap-2.5 group">
                                                        ...
                                                        <span className="text-[13px] text-[#172B4D] font-medium group-hover:text-[#0052CC] transition-colors">{a.username}</span>
                                                    </div>
                                                ))}
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="flex items-center justify-between group cursor-pointer" onClick={() => setExtending(true)}>
                                    ...
                                    <CalendarClock className="w-3.5 h-3.5 text-[#0052CC] opacity-0 group-hover:opacity-100 transition-opacity" />
                                </div>
                            </div>
