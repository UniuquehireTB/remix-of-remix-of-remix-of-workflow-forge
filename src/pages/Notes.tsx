            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <AnimatedDropdown
                  ...
                  size="sm"
                  className="w-32"
                  triggerClassName="bg-muted/30 border border-border/50 h-9 rounded-xl text-xs font-bold shadow-none"
                />
              </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h2 className="text-xl font-black leading-none mb-1.5 tracking-tight">
                            {panelMode === "create" ? "Create" : (canEdit ? "Edit" : "View")} {createType === "note" ? "Note" : "List"}
                          </h2>
                    ...
                    <div className="px-6 py-4 border-t border-border bg-muted/30 flex items-center justify-between shrink-0">
                      <div className="flex items-center gap-4">
                        ...
                        {!isSyncing && panelMode === "edit" && (
                          <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-success/60">
                      ...
                      {canEdit && (
                        ...
                        >
                          ...
                          {panelMode === "create" ? (createType === "note" ? "Create Note" : "Create List") : "Update Note"}
                        </Button>
                      )}
                    </div>
                  </motion.div>
